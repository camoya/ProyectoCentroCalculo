...
import usac.centrocalculo.listas.ListaFormaCeroCuatroUno;

/**
 *
 * @author Cristhofer Moya
 */
public class LectorFormaCeroCuatroUno {
     ListaFormaCeroCuatroUno listaCeroCuatroUno= new ListaFormaCeroCuatroUno();
